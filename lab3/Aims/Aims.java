...
public class Aims {
    public static void main(String[] args) {
        ...
        DigitalVideoDisc dv5 = new DigitalVideoDisc("HuyenNguyen", "anime ost", "Duc Anh",100,88.45f);
        DigitalVideoDisc dv6 = new DigitalVideoDisc("Ruby", "anime ost", "HUST",100,88.45f);
        DigitalVideoDisc dv7 = new DigitalVideoDisc("Ruby2", "anime ost", "HUST",100,88.45f);
        DigitalVideoDisc dv8 = new DigitalVideoDisc("Ruby3", "anime ost", "HUST",100,88.45f);
        DigitalVideoDisc dv9 = new DigitalVideoDisc("Ruby4", "anime ost", "HUST",100,88.45f);
        DigitalVideoDisc dv10 = new DigitalVideoDisc("Ruby5", "anime ost", "HUST",100,88.45f);
        DigitalVideoDisc dv11= new DigitalVideoDisc("Ruby6", "anime ost", "HUST",100,88.45f);
        DigitalVideoDisc dv12 = new DigitalVideoDisc("Ruby7", "anime ost", "HUST",100,88.45f);
        DigitalVideoDisc dv13= new DigitalVideoDisc("Ruby8", "anime ost", "HUST",100,88.45f);
